...
MAVIS_HOME = Path(os.getenv("MAVIS_HOME") or (Path.home() / ".mavis"))
...
def check_config(groq_key, eleven_key):
    """Check mavis config.yaml."""
    section("Configuration")

    config_path = MAVIS_HOME / "config.yaml"
    ...
    # Voice mode state
    voice_mode_path = MAVIS_HOME / "gateway_voice_mode.json"
